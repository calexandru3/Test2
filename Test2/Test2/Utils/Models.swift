...
func getMyProfile()->[ProfileStruct] {
    return [ProfileStruct.init(image: UIImage(named: "cat1")!, name: "Alex", adress: "Bucharest", description: "No description aviable!")]
}

func getMyFriends()->[ProfileStruct] {
    return [
            ProfileStruct.init(image: UIImage(named: "cat2")!, name: "Dorel", adress: "Bucharest", description: "Răspândeşte lumina, iar întunericul se va risipi de la sine – Erasmus"),
            ProfileStruct.init(image: UIImage(named: "cat3")!, name: "Mirel", adress: "Craiova", description: "Cuvintele sunt precum frunzele. Acolo unde ele abundă, arareori mai găseşti şi roade împrejur. – Alexander Pope"),
